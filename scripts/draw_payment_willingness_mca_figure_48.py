...
POINTS = [
    ...
    {"label": "3000元以下", "group": "月可支配收入", "x": -1.08, "y": 0.02},
    {"label": "3001-5000元", "group": "月可支配收入", "x": 0.50, "y": 0.53},
    {"label": "5001-8000元", "group": "月可支配收入", "x": 0.46, "y": -0.45},
    {"label": "8001-15000元", "group": "月可支配收入", "x": 0.35, "y": -0.14},
    {"label": "15000元以上", "group": "月可支配收入", "x": 0.74, "y": -0.50},
