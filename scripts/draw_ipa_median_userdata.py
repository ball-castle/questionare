...
def main() -> None:
    ...
    out_scatter = out_dir / "图7-3_IPA四象限散点图_中位数阈值_用户最新数据.png"
    out_bar = out_dir / "图7-2_各文旅属性重要度与表现度均值对比_中位数阈值_用户最新数据.png"
    out_audit = out_dir / "IPA_中位数阈值_用户最新数据_audit.json"
